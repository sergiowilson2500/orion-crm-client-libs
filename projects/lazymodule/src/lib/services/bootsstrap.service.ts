...
export class BootstrapService {
  ...
  async bootstrapComponentByKey(key: LoadTypeKey, container: ViewContainerRef) {
    switch (key) {
      case LazyLoadBroker.Financial: {
        ...
        this.createBootstrapComponent(DashboardFinancialsModule, container);
      ...
      case LazyLoadBroker.MarketSummary: {
        ...
        this.createBootstrapComponent(DashboardMarketSummaryModule, container);
        break;
      }
  ...
  createBootstrapComponent<TModule>(ngModule: NgModuleOfType<TModule>, container: ViewContainerRef) {
